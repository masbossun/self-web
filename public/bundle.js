...
var app = (function () {
    ...
    */
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$6, 10, 4, 151);
    			attr_dev(div, "class", "bg-black py-3 px-5");
    			add_location(div, file$6, 9, 2, 114);
    			attr_dev(a, "href", "#");
    ...
    // (22:2) {#if positionY >= contentHeight * 0.8}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$c, 22, 4, 545);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(22:2) {#if positionY >= contentHeight * 0.8}",
    		ctx
    	});
    ...
    // (32:2) <Content     bind:clientHeight={contentHeight}     classes="flex flex-col lg:flex-row justify-center items-center py-16 lg:py-0">
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(32:2) <Content     bind:clientHeight={contentHeight}     classes=\\\"flex flex-col lg:flex-row justify-center items-center py-16 lg:py-0\\\">",
    		ctx
    	});
    ...
    // (55:2) <Content     id="bio"     classes="flex flex-col lg:flex-row justify-center items-center relative">
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$c, 62, 8, 1935);
    			add_location(br1, file$c, 64, 8, 1966);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(55:2) <Content     id=\\\"bio\\\"     classes=\\\"flex flex-col lg:flex-row justify-center items-center relative\\\">",
    		ctx
    	});
    ...
    // (83:2) <Content     id="projects"     classes="flex flex-col lg:flex-row items-center relative">
    ...
    `
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(83:2) <Content     id=\\\"projects\\\"     classes=\\\"flex flex-col lg:flex-row items-center relative\\\">",
    		ctx
    	});
    ...
    // (101:2) <Content classes="flex flex-col lg:flex-row items-center relative">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(101:2) <Content classes=\\\"flex flex-col lg:flex-row items-center relative\\\">",
    		ctx
    	});
    ...
    // (109:2) <Content classes="flex flex-col lg:flex-row items-center relative">
    function create_default_slot(ctx) {
      ...
      `
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(109:2) <Content classes=\\\"flex flex-col lg:flex-row items-center relative\\\">",
    		ctx
    	});
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$c, 20, 0, 468);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
