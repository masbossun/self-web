...
var app = (function () {
    ...
    */
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			a = element("a");
    			div = element("div");
    			attr_dev(div, "id", "logo-container");
    			add_location(div, file$6, 9, 2, 137);
    			attr_dev(a, "href", "https://masbossun.web.id");
    			attr_dev(a, "class", a_class_value = "cursor-pointer " + /*classes*/ ctx[0]);
    			add_location(a, file$6, 8, 0, 66);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*classes*/ 1 && a_class_value !== (a_class_value = "cursor-pointer " + /*classes*/ ctx[0])) {
    ...
    class Logo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment$6, safe_not_equal, { classes: 0 });
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$7, 30, 4, 705);
    			attr_dev(div, "class", div_class_value = "bg-white py-2 px-4 " + (/*hasShadow*/ ctx[2] && "shadow-button") + " svelte-3fxp10");
    			add_location(div, file$7, 29, 2, 637);
    			attr_dev(a, "href", /*link*/ ctx[0]);
    			attr_dev(a, "class", "cursor-pointer px-4");
    			add_location(a, file$7, 28, 0, 564);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*hasShadow*/ 4 && div_class_value !== (div_class_value = "bg-white py-2 px-4 " + (/*hasShadow*/ ctx[2] && "shadow-button") + " svelte-3fxp10")) {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			create_component(navlink3.$$.fragment);
    			attr_dev(div0, "class", "flex md:hidden cursor-pointer w-8 h-8");
    			add_location(div0, file$8, 20, 2, 415);
    			attr_dev(div1, "class", "hidden md:flex");
    			add_location(div1, file$8, 45, 2, 1227);
    			attr_dev(div2, "class", div2_class_value = "flex justify-between items-center p-2 " + /*classes*/ ctx[0]);
    			add_location(div2, file$8, 18, 0, 340);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*classes*/ 1 && div2_class_value !== (div2_class_value = "flex justify-between items-center p-2 " + /*classes*/ ctx[0])) {
    ...
    class Navbar extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$8, safe_not_equal, { classes: 0 });
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 8, 0, 151);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Content extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$9, safe_not_equal, { classes: 1, id: 2, clientHeight: 0 });
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*classes*/ 1 && div1_class_value !== (div1_class_value = "bg-black p-8 -mx-2 lg:ml-32 w-full " + /*classes*/ ctx[0])) {
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			span0 = element("span");
    			t0 = text("Robert C. Martin, Clean Code:\n        ");
    			br0 = element("br");
    			t1 = text("\n        A Handbook of Agile\n        ");
    			br1 = element("br");
    ...
    class Footer extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$b, safe_not_equal, { classes: 1 });
    ...
    // (34:2) {#if positionY >= contentHeight * 0.8}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$c, 34, 4, 859);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(34:2) {#if positionY >= contentHeight * 0.8}",
    		ctx
    	});
    ...
    // (44:2) <Content     bind:clientHeight={contentHeight}     classes="flex flex-col lg:flex-row justify-center items-center py-16 lg:py-0">
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(44:2) <Content     bind:clientHeight={contentHeight}     classes=\\\"flex flex-col lg:flex-row justify-center items-center py-16 lg:py-0\\\">",
    		ctx
    	});
    ...
    // (67:2) <Content     id="bio"     classes="flex flex-col lg:flex-row justify-center items-center relative">
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$c, 74, 8, 2249);
    			add_location(br1, file$c, 76, 8, 2280);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(67:2) <Content     id=\\\"bio\\\"     classes=\\\"flex flex-col lg:flex-row justify-center items-center relative\\\">",
    		ctx
    	});
    ...
    // (95:2) <Content     id="projects"     classes="flex flex-col lg:flex-row items-center relative">
    ...
    `
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(95:2) <Content     id=\\\"projects\\\"     classes=\\\"flex flex-col lg:flex-row items-center relative\\\">",
    		ctx
    	});
    ...
    // (113:2) <Content classes="flex flex-col lg:flex-row items-center relative">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(113:2) <Content classes=\\\"flex flex-col lg:flex-row items-center relative\\\">",
    		ctx
    	});
    ...
    // (121:2) <Content classes="flex flex-col lg:flex-row items-center relative">
    function create_default_slot(ctx) {
      ...
      `
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(121:2) <Content classes=\\\"flex flex-col lg:flex-row items-center relative\\\">",
    		ctx
    	});
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$c, 32, 0, 782);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
